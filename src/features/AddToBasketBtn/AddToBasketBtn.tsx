...
import { ButtonProps, CircularProgress, IconButton, LinearProgress, SxProps, Theme, Typography } from '@mui/material';
import { SxPropsArr, SxStyles } from '@/shared/types';
import { useAddToBasketBtn } from '@/features/AddToBasketBtn/useAddToBasketBtn';
...
export function AddToBasketBtn({
  ...
  return isIconBtn ? (
    ...
    <BtnCasual variant="outlined" disabled={isAvailable} onClick={addToBasket} sx={[sxStyles.btnCasual, ...sxBtn]}>
