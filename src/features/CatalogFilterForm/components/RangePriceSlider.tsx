...
import { SLIDER_MIN_DISTANCE, SLIDER_STEP } from '@/features/CatalogFilterForm/CatalogFilterForm.constants';
...
import type { IAction, FilterPayload, IFilterState } from '@/pages/CatalogPage/hooks/filterReducer/filterReducer.interface';
