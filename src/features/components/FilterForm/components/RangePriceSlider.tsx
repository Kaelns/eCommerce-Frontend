...
import { SLIDER_MIN_DISTANCE, SLIDER_STEP } from '@/features/components/FilterForm/FilterForm.constants';
...
import type {
  ...
  FilterPayload,
  IFilterState
} from '@/pages/CatalogPage/hooks/filterReducer/filterReducer.interface';
