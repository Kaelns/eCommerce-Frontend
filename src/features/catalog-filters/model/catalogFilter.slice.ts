...
import { setCategoryIdAndNameActionHelper } from '@/features/catalog-filters/lib/redux/helpers/setCategoryIdAndNameAction';
import { convertFilterToQueryArgs } from '@/features/catalog-filters/lib/redux/helpers/convertFilterToQueryArgs/convertFilterToQueryArgs';
...
const INIT_FILTER = {
  filters: {
    ...
    categoryId: NO_CATEGORY_ID as string,
