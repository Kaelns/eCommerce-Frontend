...
import type { ConvertSearchReturn } from '@/features/catalog-filters/lib/redux/helpers/convertFilterToQueryArgs/types';

import { queryArgsProductProps } from '@/shared/api/ecommerce-api';

import { ProductConsts } from '@/entities/product';
import { NO_CATEGORY_ID } from '@/entities/categories';
...
export function convertCategoriesQueryArgs(categoryId: string | undefined): string {
  ...
  const category = categoryId !== NO_CATEGORY_ID ? categoryId : '';
