import { categoriesObjMock } from '@/entities/categories/model/categories.mock';
import { convertToBreadcrumbCategories } from '@/shared/lib/helpers/convertToBreadcrumbCategories';
