...
import { RedirectLoginRouter } from '@/features/router/RedirectLoginRouter';
...
export const router = createBrowserRouter(
  createRoutesFromElements(
    <Route element={<AppLayout />}>
      ...
      <Route
        path={Paths.USER}
        element={<RedirectLoginRouter IfLogged={<UserPage />} IfUnLogged={<Navigate to={Paths.LOGIN} />} />}
      />
      <Route
        path={Paths.LOGIN}
        element={<RedirectLoginRouter IfLogged={<Navigate to={Paths.MAIN} />} IfUnLogged={<LoginPage />} />}
      />
      <Route
        path={Paths.BASKET}
        element={<RedirectLoginRouter IfLogged={<BasketPage />} IfUnLogged={<Navigate to={Paths.LOGIN} />} />}
      />
      <Route
