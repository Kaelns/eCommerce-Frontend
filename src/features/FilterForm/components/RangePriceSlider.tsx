...
import { SLIDER_MIN_DISTANCE, SLIDER_STEP } from '@/features/FilterForm/FilterForm.constants';
...
import { IAction, FilterPayload, IFilterState } from '@/pages/CatalogPage/hooks/filterReducer/filterReducer.interface';
