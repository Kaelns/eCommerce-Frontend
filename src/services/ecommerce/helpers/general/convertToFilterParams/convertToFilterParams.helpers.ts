...
import { PROPERTY } from '@/services/ecommerce/helpers/general/convertToFilterParams/convertToFilterParams.interface';
import { findInCategories } from '@/services/ecommerce/helpers/products/findInCategories';
import { FRACTION_DOZENS, LANGUAGE } from '@/services/ecommerce/constants';
import { MAX_MONEY, MIN_MONEY, NO_CATEGORY } from '@/pages/CatalogPage/hooks/filterReducer/filterReducer.constants';
import type { IFilterColorsKeys, IFilterColorsState } from '@/features/components/FilterForm/FilterForm.types';
import type { IConvertSearchReturn } from '@/services/ecommerce/helpers/general/convertToFilterParams/convertToFilterParams.interface';
