...
import { SRCSET, MOCK_PRICE } from '@/shared/api/ecommerce-api';

import { CartProductQuantity } from '@/pages/CartPage/ui/widgets/CartProductCard/components/CartProductQuantity';
...
export function CartProductCard({ productId, imgHeight = { zero: 300, mobile: 200 } }: CartProductCardProps) {
  ...
  const { price, discount, fractionDigits, discountedPrice } = cartProductData.pricesObj[country] ?? MOCK_PRICE;
