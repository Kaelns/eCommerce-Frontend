export { getMaxDate } from '@/shared/lib/utils/dates/getMaxDate';
export { getMinDate } from '@/shared/lib/utils/dates/getMinDate';
export { createSrcSet } from '@/shared/lib/utils/strings/createSrcSet';
