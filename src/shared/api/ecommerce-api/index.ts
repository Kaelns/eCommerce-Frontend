...
export { getErrorMessage } from '@/shared/api/ecommerce-api/lib/helpers/getErrorMessage';
export { actionsEcommerceReduxExtension } from '@/shared/api/ecommerce-api/config/actionsEcommerceReduxExtension';
